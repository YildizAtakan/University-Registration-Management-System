<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ObtainStudents.aspx.cs" Inherits="HW2.ObtainStudents" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p style="height: 44px; font-size: x-large; color: white">Obtain List of All Students</p>
    ...
    <asp:AccessDataSource ID="AccessDataSource1" runat="server" DataFile="~/App_Data/UserDB.accdb" SelectCommand="SELECT [Username], [Name], [Surname], [Email], [AccountType], [ActiveAccount] FROM [UserList] WHERE ([AccountType] = ?)">
        <SelectParameters>
            <asp:Parameter DefaultValue="0" Name="AccountType" Type="Int32" />
        </SelectParameters>
