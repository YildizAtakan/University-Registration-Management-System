<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ResetPW.aspx.cs" Inherits="HW2.ResetPW" %>
...
<asp:Content ID="Content2" runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <p style="height: 44px; font-size: x-large; color: white">Reset the Password of An Existing User</p>
