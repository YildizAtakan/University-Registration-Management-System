<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="AddProf.aspx.cs" Inherits="HW2.AddProf" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p style="height: 44px; font-size: x-large; color: white">Define a New Professor</p>
    <table style="width: 100%; height: 190px;">
        ...
        <tr>
            <td height="40" style="font-size: medium">Password:</td>
            <td>
