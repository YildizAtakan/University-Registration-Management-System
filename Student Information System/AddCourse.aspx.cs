    ...
    public partial class AddCourse : System.Web.UI.Page
    {
        ...
        protected void btn_update_Click(object sender, EventArgs e)
        {
            ...
            using (OleDbConnection con = new OleDbConnection(connDB))
            {
                ...
                cmd.CommandText = "INSERT INTO [Courses] VALUES ((@p1), (@p2), (@p3), (@p4), (@p5),(@p6), (@p7));";
                cmd.Parameters.AddWithValue("@p1", txt_name.Text);
                cmd.Parameters.AddWithValue("@p2", txt_desc.Text);
                cmd.Parameters.AddWithValue("@p3", txt_quota.Text);
                cmd.Parameters.AddWithValue("@p4", txt_finaldate.Text);
                cmd.Parameters.AddWithValue("@p5", txt_credits.Text);
                cmd.Parameters.AddWithValue("@p6", txt_consent.Text);
                cmd.Parameters.AddWithValue("@p7", txt_teachingprof.Text);
