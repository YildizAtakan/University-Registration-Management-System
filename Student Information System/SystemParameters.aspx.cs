...
namespace HW2
{
    public partial class SystemParameters : System.Web.UI.Page
    {
        ...
        protected void btn_update_Click(object sender, EventArgs e)
        {
            ...
            string maxstucourse = txt_maxstucourse.Text;
            string maxprofcourse = txt_maxprofcourse.Text;
            ...
            using (OleDbConnection con = new OleDbConnection(connDB))
            {
                ...
                cmd.CommandText = "Update [SystemParameters] SET [MinPwd]=(@p1),[MaxPwd]=(@p2),[MaxCourse]=(@p3),[MaxStuCourse]=(@p4),[MaxProfCourse]=(@p5) WHERE id=1;";
                cmd.Parameters.AddWithValue("@p1", minpwd);
                cmd.Parameters.AddWithValue("@p2", maxpwd);
                cmd.Parameters.AddWithValue("@p3", maxcourse);
                cmd.Parameters.AddWithValue("@p4", maxstucourse);
                cmd.Parameters.AddWithValue("@p5", maxprofcourse);
